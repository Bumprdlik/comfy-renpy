...
app.post('/api/export-rpy', (req, res) => {
  ...
  if (!fs.existsSync(screensFile)) {
    const screensContent = [
      ...
      '        background "#000000aa"',
      '        padding (10, 6)',
      '        textbutton ("Questy [active_count]" if active_count > 0 else "Questy") action Show("comfy_quest_log"):',
      '            text_size 18',
      '            text_color "#ffffff"',
      ...
      '                text "Žádné aktivní questy." size 14 color "#7f8c8d"',
      '                text "Mluv s postavami ve světě pro zahájení questů." size 12 color "#555" italic True',
